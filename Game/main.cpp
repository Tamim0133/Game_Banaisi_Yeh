...
int main(int argc, char ** argv)
{
    ...
    startSound = Mix_LoadWAV("assets/sounds/game_start.wav");    Mix_Chunk * endSound =
     Mix_LoadWAV("assets/sounds/smb_gameover.wav");    Mix_Chunk * jumpSound =
     Mix_LoadWAV("assets/sounds/smb_kick.wav");    Mix_Chunk * manaPotionSound =
    Mix_LoadWAV("assets/sounds/smb_powerup.wav");    Mix_Chunk * coinSound =
    Mix_LoadWAV("assets/sounds/smb_coin.wav");

    //Load music
    
//    Sound * JumpSound, *GameOverSound, *CoinSound, *ManaPotionSound, *GameStartSound;
//    JumpSound = new Sound("assets/sounds/smb_kick.wav");
//    GameOverSound = new Sound("assets/sounds/smb_gameover.wav");    JumpSound = new Sound("assets/sounds/smb_kick.wav");
//
//    CoinSound = new Sound("assets/sounds/smb_coin.wav");
//    ManaPotionSound = new Sound("assets/sounds/smb_powerup.wav");
//
    ...
    int new_frame_till_jump_complete;
      ...
      {
//          CoinSound -> StopSound();
          SDL_Texture* running[6] = {texture1, texture2, texture3, texture4, texture5, texture6}; // Bah ei jinishta matha theke ashlo .. sprite sheet ken use korbo :') ... akta time por por image rendering switch kore dibo ... He he ....
         ...
         // number of (ms) since SDL library initialization.
